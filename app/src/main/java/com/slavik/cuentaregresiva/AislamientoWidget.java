 ...
 */
public class AislamientoWidget extends AppWidgetProvider {

    private AlarmManager alarmManager;
    private static final String ACTUALIZAR_WIDGET = "ACTUALIZAR_WIDGET_AISLAMIENTO";
    ...
    private static String calcularDiasRestantes() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            evento.set(Calendar.MONTH, Calendar.JANUARY);
            evento.set(Calendar.DAY_OF_MONTH, 16);
...
//                    context,
//                    MainActivity.canalCovid,
//                    "00:00",
//                    "En " + diasRestantes + " días se termina el aislamiento! 🤒🤧",
